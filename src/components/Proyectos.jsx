      ...
      <div className="projects fade-in">
        <div className="project card dark">
          ...
          <div className="card-text">
            ...
            <div className="card-preview-txt">
              Aplicación carrito de la compra desarrollada en PHP, JavaScript,
              MySQL con una capa de Bootstrap. Posee sistema de login y registro
              de usuario, panel de admin, añadir productos mediante formulario
              con subida de imágenes al servidor y otras funciones. Aún en
              desarrollo.
            </div>
        ...
        <div className="project card dark">
          ...
          <div className="card-text">
            ...
            <div className="card-bar"></div>
            <div className="card-preview-txt">
              Desarrollada en React (y la maravilla de Vite), esta aplicación
              hace uso de la API de{" "}
              <a href="https://giphy.com/" target="_blank">
                Giphy
              </a>{" "}
              para la búsqueda de imágenes en formato Gif. Cuenta con paginación
        ...
        <div className="project card dark">
          ...
          <div className="card-text">
            ...
            <div className="card-preview-txt">
              ...
              navegación por la página. Sujeto a cambios 😅.
            </div>
            <div className="card-icon-links">
              <a
        ...
        <div className="project card dark">
          ...
          <div className="card-text">
            ...
            <div className="card-bar"></div>
            <div className="card-preview-txt">
              Aplicación de previsión del tiempo meteorológico. Desarrollado en
              React, Sass para los estilos y Vite para el despliegue.
              Actualmente toma la posición actual mediante la api geolocation de
              html5 para mostrar la información. Pensado implementar búsqueda
